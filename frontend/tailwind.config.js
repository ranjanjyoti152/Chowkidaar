...
export default {
  ...
  theme: {
    extend: {
      ...
      boxShadow: {
        'glass': '0 8px 32px 0 rgba(6, 182, 212, 0.15), inset 0 1px 0 0 rgba(255, 255, 255, 0.1)',
        'glass-lg': '0 12px 48px 0 rgba(6, 182, 212, 0.25), inset 0 1px 0 0 rgba(255, 255, 255, 0.15)',
        'glass-xl': '0 25px 50px -12px rgba(6, 182, 212, 0.35)',
